...
import {Color} from "../../_snowpack/pkg/@templatone.kreslo.v3.7.0.js";
...
export class InputColorPicker extends Input {
  ...
  hasSameValueAs(value) {
    ...
    return current.red == test.red && current.green == test.green && current.blue == test.blue && current.alpha == test.alpha;
  }
  focus() {
