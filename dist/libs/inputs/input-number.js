...
import {Input, INPUTMODE} from "./Input.js";
const regex = {
  spaces: /\s+/g,
  validChars: /[^0-9,.+\- ]/g,
  decimalSeparator: /\.|\,/
...
export class InputNumber extends Input {
  constructor() {
    ...
    this._computedInputMode = INPUTMODE.Decimal;
    this._inputMode = INPUTMODE.Decimal;
  ...
  set step(v) {
    ...
    if (Number.isInteger(this._step))
      ...
      this._computedInputMode = INPUTMODE.Numeric;
    this.invalidate();
  }
  get value() {
    return this._value;
