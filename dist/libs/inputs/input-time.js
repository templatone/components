import {html} from "../../_snowpack/pkg/lit.v2.0.0-rc.1.js";
import {Input} from "./Input.js";
import {Utils} from "../../_snowpack/pkg/@templatone.kreslo.v3.7.0.js";
const style = html`
<style>
    :host {
        display: flex;
...
const _InputTime = class extends Input {
  constructor() {
    super();
  ...
  _evaluateInput(input, max, nextInput) {
    ...
    const part1 = raw1.match(_InputTime.regexp.numbers)?.join("") ?? "";
    const part2 = raw2.match(_InputTime.regexp.numbers)?.join("") ?? "";
  ...
  _updateValue(value) {
    this._value = _InputTime.applyFilters(this.filters, value);
    ...
    switch (name.toLocaleLowerCase()) {
      ...
      case "value":
        if (newValue !== null && newValue.trim() !== "") {
          ...
          const p2 = p1[2] ? p1[2].split(".")[1] : void 0;
...
export let InputTime = _InputTime;
InputTime.regexp = {
  numbers: /[0-9]+/g
};
